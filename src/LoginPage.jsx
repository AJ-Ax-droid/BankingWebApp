...
import lightbgvd from './images/BMBwithNoteBackground.png';
import BMBBuildingDark from './images/BMBBuildingDArk.png';
...
export default function LoginPage(props) {
  ...
  return (
    <main className='blankbghovereffect'
     style={{
      minHeight: '100vh',
      width: '100vw',
      ...
      <CssVarsProvider {...props}>
        ...
        className='Box-PaperBg'
          sx={{
            ...
            backgroundColor: 'rgba(255,255,255,0.01)', // add overlay for readability
        ...
        >
          ...
          <Button sx={{color:'white'}} variant="text" onClick={() => navigate('/Registration')}>New To BMB</Button>
        </Sheet>
      </CssVarsProvider>
    </main>
  );
